...
/**
 * Api services for the `Class` model.
 */
@Injectable()
export class ClassApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public findByIdStudents(id: any, fk: any): Observable<any> {
   ...
   */
  public destroyByIdStudents(id: any, fk: any): Observable<any> {
   ...
   * </em>
   */
  public updateByIdStudents(id: any, fk: any, data: Student = new Student()): Observable<any> {
   ...
   * </em>
   */
  public getGeneration(id: any, refresh: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Classes/:id/generation";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getStudents(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Classes/:id/students";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createStudents(id: any, data: Student = new Student()): Observable<any> {
   ...
   *  - `count` – `{number}` - 
   */
  public countStudents(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Classes/:id/students/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyStudents(id: any, data: Student[] = new Array<Student>()): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Classes/:id/students";
    let _routeParams: any = {
