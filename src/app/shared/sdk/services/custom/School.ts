...
/**
 * Api services for the `School` model.
 */
@Injectable()
export class SchoolApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public findByIdGenerations(id: any, fk: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/generations/:fk";
   ...
   */
  public destroyByIdGenerations(id: any, fk: any): Observable<any> {
   ...
   * </em>
   */
  public updateByIdGenerations(id: any, fk: any, data: Generation ): Observable<any> {
   ...
   * </em>
   */
  public findByIdTeachers(id: any, fk: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/teachers/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
  public destroyByIdTeachers(id: any, fk: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/teachers/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public updateByIdTeachers(id: any, fk: any, data: Teacher ): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/teachers/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getGenerations(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/generations";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createGenerations(id: any, data: Generation ): Observable<any> {
   ...
   * This method returns no data.
   */
  public deleteGenerations(id: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/generations";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countGenerations(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/generations/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getTeachers(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/teachers";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createTeachers(id: any, data: Teacher ): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/teachers";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countTeachers(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/teachers/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyGenerations(id: any, data: Array<Generation> = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/generations";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyTeachers(id: any, data: Array<Teacher> = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Schools/:id/teachers";
    let _routeParams: any = {
