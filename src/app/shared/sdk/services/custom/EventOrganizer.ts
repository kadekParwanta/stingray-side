...
/**
 * Api services for the `EventOrganizer` model.
 */
@Injectable()
export class EventOrganizerApi extends BaseLoopBackApi {
  ...
  /**
   * Queries photos of EventOrganizer.
   *
   * @param {any} id Project id
   *
   * @param {object} filter 
  ...
  /**
   * Counts photos of EventOrganizer.
   *
   * @param {any} id Project id
   *
  ...
  public countPhotos(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EventOrganizers/:id/photos/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
